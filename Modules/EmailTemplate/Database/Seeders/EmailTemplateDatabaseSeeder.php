    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                ...
                'template_body' => '<p>Hi there,</p><p>Incident {INCIDENT_TITLE} has been marked as {STATUS} by {MARKED_BY}.</p><p>You can view this incident by logging in to the portal using the link below.</p><p><big><strong><a href="{INCIDENT_URL}">View Incident</a></strong></big></p><p><br>Regards<br>The {SITE_NAME} Team</p>',
