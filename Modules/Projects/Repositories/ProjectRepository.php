...
class ProjectRepository
{
    ...
    {
        return Project::select('id', 'project_name', 'project_version', 'estimated_hours', 'start_date', 'end_date')->get();
    }
    ...
    /**
     *  Get user project with sprint.
     *
     * @return Response
     */
    // public function getMyProjectWithSprint()
    // {
    //     $users = Auth::user();
    //     $user_table = config('core.acl.users_table');

    //     return $users->projects()->with(['sprints'])->orderBy('id', 'desc')->get();
    // }
